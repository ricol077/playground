...
void BEEP_Init(void)
{
	...
	*((volatile unsigned long *)((((((((u32)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((u32)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(8<<2))))=0;					
}
