...
void CTR_LP(void)
{
  ...
  while (((wIstr = ((u16) *((volatile unsigned *)((0x40005C00L) + 0x44)))) & (0x8000)) != 0)
  {
    (*((volatile unsigned *)((0x40005C00L) + 0x44)) = (u16)(u16)(~(0x8000)));  
     
    EPindex = (u8)(wIstr & (0x000F));
    if (EPindex == 0)
    {
      ...
      SaveRState = ((u16)((u16)(*(((volatile unsigned *)((0x40005C00L))) + ((u8)0)))) & (0x3000));
      SaveTState = ((u16)((u16)(*(((volatile unsigned *)((0x40005C00L))) + ((u8)0)))) & (0x0030));
      { register u16 _wRegVal; _wRegVal = ((u16)(*(((volatile unsigned *)((0x40005C00L))) + ((u8)0)))) & ((0x3000)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x1000) & (0x2000))!= 0) _wRegVal ^= (0x1000); if(((0x2000) & (0x2000))!= 0) _wRegVal ^= (0x2000); (*(((volatile unsigned *)((0x40005C00L))) + ((u8)0))= (u16)_wRegVal); };
      { register u16 _wRegVal; _wRegVal = ((u16)(*(((volatile unsigned *)((0x40005C00L))) + ((u8)0)))) & ((0x0030)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x0010) & (0x0020))!= 0) _wRegVal ^= (0x0010); if(((0x0020) & (0x0020))!= 0) _wRegVal ^= (0x0020); (*(((volatile unsigned *)((0x40005C00L))) + ((u8)0))= (u16)_wRegVal); };
      ...
      if ((wIstr & (0x0010)) == 0)
      {
        ...
        ((*(((volatile unsigned *)((0x40005C00L))) + ((u8)0))= (u16)((u16)(*(((volatile unsigned *)((0x40005C00L))) + ((u8)0)))) & 0xFF7F & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))));
        In0_Process();

            
          { register u16 _wRegVal; _wRegVal = ((u16)(*(((volatile unsigned *)((0x40005C00L))) + ((u8)0)))) & ((0x3000)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x1000) & SaveRState)!= 0) _wRegVal ^= (0x1000); if(((0x2000) & SaveRState)!= 0) _wRegVal ^= (0x2000); (*(((volatile unsigned *)((0x40005C00L))) + ((u8)0))= (u16)_wRegVal); };
          { register u16 _wRegVal; _wRegVal = ((u16)(*(((volatile unsigned *)((0x40005C00L))) + ((u8)0)))) & ((0x0030)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x0010) & SaveTState)!= 0) _wRegVal ^= (0x0010); if(((0x0020) & SaveTState)!= 0) _wRegVal ^= (0x0020); (*(((volatile unsigned *)((0x40005C00L))) + ((u8)0))= (u16)_wRegVal); };
          return;
      }
      else
      {
        ...
        wEPVal = ((u16)(*(((volatile unsigned *)((0x40005C00L))) + ((u8)0))));
        if ((wEPVal & (0x0080)) != 0)
        {
          ((*(((volatile unsigned *)((0x40005C00L))) + ((u8)0))= (u16)((u16)(*(((volatile unsigned *)((0x40005C00L))) + ((u8)0)))) & 0xFF7F & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))));
          In0_Process();
        ...
        {
          ((*(((volatile unsigned *)((0x40005C00L))) + ((u8)0))= (u16)((u16)(*(((volatile unsigned *)((0x40005C00L))) + ((u8)0)))) & 0x7FFF & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))));  
          Setup0_Process();
    ...
    else
    {
      ...
      if ((wEPVal & (0x8000)) != 0)
      {
        ...
        ((*(((volatile unsigned *)((0x40005C00L))) + EPindex)= (u16)((u16)(*(((volatile unsigned *)((0x40005C00L))) + EPindex))) & 0x7FFF & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))));
      ...
      if ((wEPVal & (0x0080)) != 0)
      {
        ...
        ((*(((volatile unsigned *)((0x40005C00L))) + EPindex)= (u16)((u16)(*(((volatile unsigned *)((0x40005C00L))) + EPindex))) & 0xFF7F & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))));
