...
#line 20 "..\\USB\\CONFIG\\usb_pwr.c"
#line 21 "..\\USB\\CONFIG\\usb_pwr.c"
...
RESULT PowerOn(void)
{
  ...
  wRegVal = (0x0001);
  (*((volatile unsigned *)((0x40005C00L) + 0x40)) = (u16)wRegVal);	 
  ...
  wInterrupt_Mask = (0x0400) | (0x0800) | (0x1000);
  (*((volatile unsigned *)((0x40005C00L) + 0x40)) = (u16)wInterrupt_Mask);	 
  return USB_SUCCESS;
}
...
RESULT PowerOff()
{
  ...
  (*((volatile unsigned *)((0x40005C00L) + 0x40)) = (u16)(0x0001));
   
  (*((volatile unsigned *)((0x40005C00L) + 0x44)) = (u16)0);				 
   
  
   
  (*((volatile unsigned *)((0x40005C00L) + 0x40)) = (u16)(0x0001) + (0x0002));
...
void Resume_Init(void)
{
  ...
  (*((volatile unsigned *)((0x40005C00L) + 0x40)) = (u16)((0x8000) | (0x1000) | (0x0800) | (0x2000) | (0x0200) | (0x0100) | (0x0400) ));
