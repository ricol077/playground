...
//#define TYE_12PIX_MODE 0x26   // so must set pixel mode, by this quick set 														// or set in pattern type previous defined
#define TYP_PCR_SEL		0x26 
...
extern u8 usb_rcv_buf[MAX_LIMIT];
extern OS_EVENT * M_USB_rsv;
extern OS_EVENT * M_POLL_flag;
typedef enum {FALSE = 0, TRUE = !FALSE} bool;
/////////////////////////////////////For OS version 
#define NONE_ACCEPT	0
#define CAN1_ACCEPT	1
#define CAN2_ACCEPT	2  // mask of sub device to process command in USB_TASK, flag
/////////2017-04-02 to fix additional reply after image send 
#define DONE_ACCEPT	4
//////////////

#define CAN_BUS_ACK_LENTH	4 // status, command, length, type. -- normal ACK on CAN bus

#define TEMPER_FUNC_ID	0x100
#define IMAGE_FUNC_ID		0x200

///////////////////////////////////////
extern u8 DualBuffer[24][MAX_LIMIT];
extern u8 ArraySize[24];
extern u8 Image_Pending;
extern u8 MonoBuffer[MAX_LIMIT];
extern u8 CAN1_Buffer[MAX_LIMIT];

extern u8 CAN1_TX_buffer[8][8];
extern u8 CAN1_TX_pending[2];
