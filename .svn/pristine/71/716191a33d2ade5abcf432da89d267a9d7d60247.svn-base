...
void delay_init(u8 SYSCLK)
{
 	...
 	((SysTick_TypeDef *) (((u32)0xE000E000) + 0x0010))->CTRL&=~(1<<2);	
	fac_us=SYSCLK/8;		
	    
#line 73 "..\\SYSTEM\\delay\\delay.c"
	fac_ms=(u16)fac_us*1000;

}								    

#line 117 "..\\SYSTEM\\delay\\delay.c"


void delay_us(u32 nus)
{		
	u32 temp;	    	 
	((SysTick_TypeDef *) (((u32)0xE000E000) + 0x0010))->LOAD=nus*fac_us; 
	((SysTick_TypeDef *) (((u32)0xE000E000) + 0x0010))->VAL=0x00;        
	((SysTick_TypeDef *) (((u32)0xE000E000) + 0x0010))->CTRL=0x01 ;      
	do
	{
		temp=((SysTick_TypeDef *) (((u32)0xE000E000) + 0x0010))->CTRL;
	}
	while((temp&0x01)&&!(temp&(1<<16)));
	((SysTick_TypeDef *) (((u32)0xE000E000) + 0x0010))->CTRL=0x00;       
	((SysTick_TypeDef *) (((u32)0xE000E000) + 0x0010))->VAL =0X00;       
}
...
{	 		  	  
	u32 temp;		   
	((SysTick_TypeDef *) (((u32)0xE000E000) + 0x0010))->LOAD=(u32)nms*fac_ms;
	((SysTick_TypeDef *) (((u32)0xE000E000) + 0x0010))->VAL =0x00;           
	((SysTick_TypeDef *) (((u32)0xE000E000) + 0x0010))->CTRL=0x01 ;          
	do
	{
