...
#line 5 "..\\SYSTEM\\usart\\usart.c"
#line 6 "..\\SYSTEM\\usart\\usart.c"
...
{      
	while((((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800))->SR&0X40)==0);
	((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800))->DR = (u8) ch;      
	return ch;
}
...
void USART1_IRQHandler(void)
{
	...
	if(((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800))->SR&(1<<5))
	{	

		res=((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800))->DR; 
...
{  	 
	...
	((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB2ENR|=1<<14;  
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800))->CRH&=0XFFFFF00F;
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800))->CRH|=0X000008B0;
		  
	((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB2RSTR|=1<<14;   
	((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB2RSTR&=~(1<<14);
	
 	((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800))->BRR=mantissa; 
	((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800))->CR1|=0X200C;  

	
	((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800))->CR1|=1<<8;    
	((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800))->CR1|=1<<5;    
	MY_NVIC_Init(3,3,((u8)0x25),2);
