...
{			 
   	...
   	((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB2RSTR|=0X01FC;
	Sys_Standby();
}
...
u8 Check_WKUP(void) 
{
	u8 t=0;
	u8 tx=0;
	*((volatile unsigned long *)((((((((u32)0x40000000) + 0x10000) + 0x2000)+12) & 0xF0000000)+0x2000000+(((((((u32)0x40000000) + 0x10000) + 0x2000)+12) &0xFFFFF)<<5)+(10<<2))))=0; 
	while(1)
	{
		if(*((volatile unsigned long *)((((((((u32)0x40000000) + 0x10000) + 0x0800)+8) & 0xF0000000)+0x2000000+(((((((u32)0x40000000) + 0x10000) + 0x0800)+8) &0xFFFFF)<<5)+(0<<2)))))
		{
			t++;
			tx=0;
		}else 
		{
			...
			if(tx>3)
			{
				*((volatile unsigned long *)((((((((u32)0x40000000) + 0x10000) + 0x2000)+12) & 0xF0000000)+0x2000000+(((((((u32)0x40000000) + 0x10000) + 0x2000)+12) &0xFFFFF)<<5)+(10<<2))))=1;
				return 0;
			}
		}
		delay_ms(30);
