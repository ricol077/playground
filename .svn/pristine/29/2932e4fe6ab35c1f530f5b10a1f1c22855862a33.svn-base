...
u8 RTC_Init(void)
{
	...
	u8 temp=0;
	if(((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR1!=0X5050)
	{	 
	  	((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB1ENR|=1<<28;     
		((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB1ENR|=1<<27;     
		((PWR_TypeDef *) (((u32)0x40000000) + 0x7000))->CR|=1<<8;           
		((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->BDCR|=1<<16;        
		((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->BDCR&=~(1<<16);     
	    ((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->BDCR|=1<<0;         
	    while((!(((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->BDCR&0X02))&&temp<250)
		{
			temp++;
			delay_ms(10);
		};
		...
		((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->BDCR|=1<<8; 
		((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->BDCR|=1<<15;
	  	while(!(((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CRL&(1<<5)));
    	while(!(((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CRL&(1<<3)));
    	((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CRH|=0X01;  		  
    	while(!(((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CRL&(1<<5)));
		((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CRL|=1<<4;              
		 
		((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->PRLH=0X0000;
		((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->PRLL=32767;          
											    
		RTC_Set(2012,9,7,13,16,55);  
		((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CRL&=~(1<<4);           
		while(!(((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CRL&(1<<5)));   
		((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR1=0X5050;  
	 	printf("FIRST TIME\n");
	}else
	{
    	while(!(((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CRL&(1<<3)));
...
{		 
	if(((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CRL&0x0001)
	{							
		RTC_Get();
		
 	}
	if(((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CRL&0x0002)
	{
		((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CRL&=~(0x0002);		
  		
  	} 				  								 
    ((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CRL&=0X0FFA;         
	while(!(((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CRL&(1<<5)));
}
...
u8 RTC_Set(u16 syear,u8 smon,u8 sday,u8 hour,u8 min,u8 sec)
{
	...
	((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CRL|=1<<4;   
	((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CNTL=seccount&0xffff;
	((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CNTH=seccount>>16;
	((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CRL&=~(1<<4);
	while(!(((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CRL&(1<<5)));
	RTC_Get();
	return 0;	    
...
u8 RTC_Get(void)
{
	...
	u32 temp=0;
	u16 temp1=0;	  
 	timecount=((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CNTH;
	timecount<<=16;
	timecount+=((RTC_TypeDef *) (((u32)0x40000000) + 0x2800))->CNTL;			 
