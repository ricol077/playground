...
#line 18 "..\\USB\\CONFIG\\hw_config.c"
...
#line 19 "..\\USB\\CONFIG\\hw_config.c"
...
#line 20 "..\\USB\\CONFIG\\hw_config.c"
...
#line 21 "..\\USB\\CONFIG\\hw_config.c"
...
#line 22 "..\\USB\\CONFIG\\hw_config.c"
...
#line 23 "..\\USB\\CONFIG\\hw_config.c"
...
void Set_USBClock(void)
{
 	((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->CFGR&=~(1<<22); 
	((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB1ENR|=1<<23; 
}
...
void USB_Interrupts_Config(void)
{
	...
	((EXTI_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0400))->IMR|=1<<18;
 	((EXTI_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0400))->RTSR|=1<<18;
	MY_NVIC_Init(1,0,((u8)0x14),2);
	MY_NVIC_Init(0,0,((u8)0x2A),2);     
}
