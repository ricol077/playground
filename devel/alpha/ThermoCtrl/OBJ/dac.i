...
void Dac1_Init(void)
{
	...
	((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB1ENR|=1<<29;   
	   	 
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800))->CRL&=0XFFF0FFFF; 
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800))->CRL|=0X00000000;

	((DAC_TypeDef *) (((u32)0x40000000) + 0x7400))->CR|=1<<0;	
	((DAC_TypeDef *) (((u32)0x40000000) + 0x7400))->CR|=1<<1;	
	((DAC_TypeDef *) (((u32)0x40000000) + 0x7400))->CR|=0<<2;	
	((DAC_TypeDef *) (((u32)0x40000000) + 0x7400))->CR|=0<<3;	
	((DAC_TypeDef *) (((u32)0x40000000) + 0x7400))->CR|=0<<6;	
	((DAC_TypeDef *) (((u32)0x40000000) + 0x7400))->CR|=0<<8;	
	((DAC_TypeDef *) (((u32)0x40000000) + 0x7400))->CR|=0<<12;	

	((DAC_TypeDef *) (((u32)0x40000000) + 0x7400))->DHR12R1=0;
}
...
void Dac1_Set_Vol(u16 vol)
{
	...
	temp/=1000;
	temp=temp*4096/3.3;
	((DAC_TypeDef *) (((u32)0x40000000) + 0x7400))->DHR12R1=temp;
}
